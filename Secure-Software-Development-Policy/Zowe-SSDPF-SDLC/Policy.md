...
- Z-SSD-LP:A1.3.PW-RWS-AWC (Acquire Well-Secured software Components) / SSDF:PW.4.1: 
...
- Z-SSD-LP:A1.3.PW-RWS-CWC (Create Well-Secured software Components) / SSDF:PW.4.2: 
...
- Z-SSD-LP:A1.3.PW-RWS-CRC (Components Requirements Compliance) / SSDF:PW.4.4: 
...
- Z-SSD-LP:A1.3.PW-RWS-VCI (Verify Components Integrity) / SSDF:PW.4.5: 
